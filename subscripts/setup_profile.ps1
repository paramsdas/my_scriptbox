...
$user_name = Get-Content $PSScriptRoot\..\config\config_stripped.yaml | yq '.user.name'
$user_working_directory = Get-Content $PSScriptRoot\..\config\config_stripped.yaml | yq '.user.working_directory'
